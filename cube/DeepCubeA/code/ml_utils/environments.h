...
/*** Puzzle15 ***/
class Puzzle15: public Environment {
	private:
		static const int numActions = 4;
		static uint8_t **swapZeroIdxs;

		std::vector<uint8_t> state;
		uint8_t zIdx;
	public:
		Puzzle15(std::vector<uint8_t> state, uint8_t zIdx);
		Puzzle15(std::vector<uint8_t> state);
		~Puzzle15();

		
    virtual Puzzle15 *getNextState(int action) const;
...
/*** Puzzle24 ***/
class Puzzle24: public Environment {
	private:
		static const int numActions = 4;
		static uint8_t **swapZeroIdxs;
		...
		uint8_t zIdx;
	public:
		Puzzle24(std::vector<uint8_t> state, uint8_t zIdx);
		Puzzle24(std::vector<uint8_t> state);
		~Puzzle24();

		
    virtual Puzzle24 *getNextState(int action) const;
...
/*** Puzzle35 ***/
class Puzzle35: public Environment {
	private:
		static const int numActions = 4;
		static uint8_t **swapZeroIdxs;
		...
		uint8_t zIdx;
	public:
		Puzzle35(std::vector<uint8_t> state, uint8_t zIdx);
		Puzzle35(std::vector<uint8_t> state);
		~Puzzle35();

		
    virtual Puzzle35 *getNextState(int action) const;
