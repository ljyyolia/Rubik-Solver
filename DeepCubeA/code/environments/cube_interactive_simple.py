...
class Cube:
    ...
    def __init__(self,N=3,moveType=None):
        ...
        for f,n in self.legalPlays_qtm:
            ...
            adjIdxs = {0:{2:[list(range(0,N)),N-1],3:[list(range(0,N)),N-1],4:[list(range(0,N)),N-1],5:[list(range(0,N)),N-1]},
                       1:{2:[list(range(0,N)),0],3:[list(range(0,N)),0],4:[list(range(0,N)),0],5:[list(range(0,N)),0]},
                       2:{0:[0,list(range(0,N))],1:[0,list(range(0,N))],4:[N-1,list(range(N-1,-1,-1))],5:[0,list(range(0,N))]},
                       3:{0:[N-1,list(range(0,N))],1:[N-1,list(range(0,N))],4:[0,list(range(N-1,-1,-1))],5:[N-1,list(range(0,N))]},
                       4:{0:[list(range(0,N)),N-1],1:[list(range(N-1,-1,-1)),0],2:[0,list(range(0,N))],3:[N-1,list(range(N-1,-1,-1))]},
                       5:{0:[list(range(0,N)),0],1:[list(range(N-1,-1,-1)),N-1],2:[N-1,list(range(0,N))],3:[0,list(range(N-1,-1,-1))]}
                       }
            ...
            cubesIdxs = [[0,list(range(0,N))],[list(range(0,N)),N-1],[N-1,list(range(N-1,-1,-1))],[list(range(N-1,-1,-1)),0]]
